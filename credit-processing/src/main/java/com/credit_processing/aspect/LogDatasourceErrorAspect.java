package com.credit_processing.aspect;

import com.credit_processing.aspect.annotations.LogDatasourceError;
import com.credit_processing.dto.DatasourceErrorEvent;
import com.credit_processing.entity.ErrorLog;
import com.credit_processing.kafka.LoggingKafkaProducer;
import com.credit_processing.repository.ErrorLogRepository;
...
public class LogDatasourceErrorAspect {
    ...
    @Value("${app.name:credit-processing}")
